...
### 5. Get the list of all projects containing the 'a' letter in the middle of the name, and show the tasks count near each project (handles projects without tasks and tasks with project_id = NULL)
